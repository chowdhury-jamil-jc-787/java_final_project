...
public class AllMemberFrame extends JFrame implements ActionListener
{
	...
	private JTextField memIdTF, memMonthTF,memMealTF,sum_bazarTF ;
	...
	public AllMemberFrame(User user)
	{
		...
		sum_bazarTF = new JTextField();
                sum_bazarTF.setBounds(620, 250, 100, 30);
                panel.add(sum_bazarTF);
	...
	public void actionPerformed(ActionEvent ae)
	{
		...
		else if(command.equals(getAllBtn.getText()))
		{
			...
			AllMembersRepo r = new AllMembersRepo();
              sum_bazarTF.setText(String.valueOf(r.sum_TotalBazar()));
